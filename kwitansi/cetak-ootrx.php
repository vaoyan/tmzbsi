...
Class Kwitansitrx extends FPDF
{
	...
	/* Header Kwitansi */
	function Header(){
		$this->Image('tmz1.png',210,2,85,25);
...
$buk='B U K T I  T R A N S F E R  P E M B A Y A R A N';
$jl='Jl. J a n t i - G e d o n g k u n i n g N o. 3 3 6  Y O G Y A K A R T A';
...
$pdf->SetFont('Arial','',13);
$pdf->Cell(90);
$pdf->Cell(30,5,'N O.S E R I  T R A N S F E R	:',0,0,'L');
$pdf->Cell(35);
$pdf->SetFont('Courier','',13);
$pdf->Cell(20,5, $KwtNum,0,1,'L');
...
$pdf->SetFont('Courier','',11);
$pdf->Cell(130,5,'##'.$fungsi->Terbilang($total).' RUPIAH ##',0,'L');
